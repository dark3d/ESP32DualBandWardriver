...
//// Firmware info stuff
#define FIRMWARE_VERSION "v2.3.0+dark3d.7"
...
#define GPS_BUFFER_WINDOW_MIN_MIN     5
#define GPS_BUFFER_WINDOW_MIN_MAX     720
#define GPS_BUFFER_WINDOW_DEFAULT_MIN 120
#define GPS_FIX_DEBOUNCE 5
#define GPS_BACKFILL_ACC_PER_S 10.0
